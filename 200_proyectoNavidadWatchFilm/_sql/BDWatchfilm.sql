...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 11-01-2021 a las 00:20:37
...
INSERT INTO `pelicula` (`id`, `nombre`, `director`, `genero`, `anio`, `puntuacion`, `plataformaId`) VALUES
(1, 'Colega dónde está mi coche', 'Danny Leiner', 'Comedia', 2000, 2, 1),
...
(1, 'jlopez', 'Josép', 'Lópep', 'j@cp', 'j', 'estrellaVacia.png', 'VOW8OBjdMGp7CQdbyPU9FH4ejhtiodF7'),
(2, 'mgarcia', 'María', 'García', 'm@c', 'm', 'usuario.png', NULL),
(3, 'fpi', 'Felipe', 'Pi', 'f@c', 'f', 'usuario.png', NULL),
(9, 'alainF', 'Alain', 'Fernandez', 'a@fernan', 'a', '60423426.jpg', NULL);

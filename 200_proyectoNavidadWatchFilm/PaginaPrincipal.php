...
<div class="filtroBusqueda">
    ...
    <form method='post' action='Busqueda.php'>
        ...
        <input style="display: none" type='text' name='nombre' id='nombre' placeholder="Buscar por Título"/>
    ...
    <div class="listado">
        ...
        <div class="pelicula">
            ...
            <div class="info">
                ...
                <p>
                    <a href='https://es.wikipedia.org/wiki/<?= $pelicula->getDirector() ?>'>Director: <?= $pelicula->getDirector() ?> </a>
                </p>
                ...
                <p>Dónde verlo: <a
                            href='https://www.google.com/search?q=<?= DAO::peliculaObtenerNombrePlataforma($pelicula->getPlataformaId()) ?>'><?= DAO::peliculaObtenerNombrePlataforma($pelicula->getPlataformaId()) ?></a>
                </p>
